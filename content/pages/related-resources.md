...
[Flybase](http://flybase.org/) is a database of genetic and molecular data for *Drosophila*. FlyBase includes data on all species from the family *Drosophilidae*; the primary species represented is *Drosophila melanogaster*.

[Berkeley Drosophila Genome Project (BDGP).](http://www.fruitfly.org/) The goals of the *Drosophila* Genome Center are to finish the sequence of the euchromatic genome *of Drosophila melanogaster* to high quality, and to generate and maintain biological annotations of this sequence.

The [Bloomington Fly Stock Center](https://bdsc.indiana.edu/) collects, maintains and distributes *Drosophila melanogaster* strains for research.
